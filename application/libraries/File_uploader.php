...
class File_uploader
{
	...
	private $no_of_files_on_folder	= 250;
	private $CI;
	...
	{
	 	$this->config['allowed_types']		= 'jpeg|jpg|png|gif';
	...
	private function get_file_name ( $field_name )
	{
		...
		return rand(0000,1111)."-".preg_replace("@[^A-Za-z0-9\-_.\/]+@i","_",$_FILES [ $field_name ] ['name']);	
	...
	{
		mkdir($this->default_path.$folder_name,0777,true);
